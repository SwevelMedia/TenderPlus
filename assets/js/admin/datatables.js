	...
	DataTable.defaults = {
		...
		oLanguage: {
			...
			oPaginate: {
				 ...
				 */
				sNext:
					'<span class="iconify-inline" style="margin-left:0px;" data-icon="ic:round-arrow-forward"></span>', //Text Next
				 ...
				 */
				sPrevious:
					'<span class="iconify-inline" style="margin-left:0px;" data-icon="ic:round-arrow-back"></span>', // text Previous
			},
			 ...
			 */
			sSearchPlaceholder: "Cari data", //placehorder
					...
					for (i = 0, ien = buttons.length; i < ien; i++) {
						...
						if (Array.isArray(button)) {
							...
							switch (button) {
								...
								case "last":
									btnDisplaybtnDisplay = lang.sLast;
