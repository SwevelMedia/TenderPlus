    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavId">
            <ul class="navbar-nav mb-3 mb-md-0  mt-2 mt-lg-0 pe-lg-4 gap-3">
                <li class="nav-item">
                    <a class="nav-link text-white link-danger text-center <?= (uri_string() == 'suplier' || uri_string() == 'user-dashboard' || uri_string() == 'asosiasi') ? 'active' : '' ?> fw-bold" href="" id="nav_dashboard">Dashboard</a>
                </li>

                            <li>
                                <a class="py-2 dropdown-item d-flex position-relative" href="#">
                ...
                <li class="nav-item" id="nav-supplier">
                    <a class="nav-link text-white link-danger text-center fw-bold <?= ($this->uri->segment(2) == 'leads') ? 'active' : '' ?>" href="<?= base_url('suplier/leads') ?>" id="nav_dashboard">Leads</a>
                </li>
                <li class="nav-item dropdown dropdown-profile" id="nav-supplier2">
                        <a class="nav-link dropdown-toggle text-white link-danger text-center <?= ($this->uri->segment(2) == 'marketing' || $this->uri->segment(2) == 'crm') ? 'active' : '' ?>" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <b>Marketing</b>
                        </a>
            ...
            $.ajax({
                ...
                success : function(data){
                    if (data != null) {
                	    ...
                	    if(kategori != 4){
                	        $('#nav-supplier').addClass('d-none');
                	        $('#nav-supplier2').addClass('d-none');
                	    }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavId">
            <ul class="navbar-nav mb-3 mb-md-0  mt-2 mt-lg-0 pe-lg-4 gap-3">
                ...
                if ($userCat == UserCategory::SRV_PROVIDER && in_array($userStatus, [UserType::TRIAL, UserType::PAID])) : ?>
                    <li class="nav-item dropdown dropdown-profile">
                        <a class="nav-link dropdown-toggle text-white link-danger text-center" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <b>Analisis</b>
                        </a>
