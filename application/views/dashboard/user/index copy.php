...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#checkbox-sedang-diikuti, #checkbox-menang, #checkbox-kalah').on('change', function() {
            ...
            // updateDataByStatus(valLPSE, valTahun, checkboxSedangDiikuti, checkboxMenang, checkboxKalah);
        });
    ...
    function get_menang_kalah_ikut(){
        $.ajax({
            url: '<?= base_url(); ?>tumbal/DashboardUser/get_menang_kalah_ikut',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                updateDoughnutChart(response.jumlah_status_peserta);
                updateBarChart(response.riwayat_menang_kalah);
            },
    ...
    function updateDataWinLose(klpd, tahun, month) {
        ...
        options: {
            ...
            onClick: function(event, elements) {
                if (elements.length > 0) {
                    ...
                    updateDataWinLose(valLPSE, valTahun, month);
                }
            }
        }
