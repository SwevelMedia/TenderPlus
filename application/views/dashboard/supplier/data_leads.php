...
<section class="bg-white pt-5 mt-5">
    <div class="container-lg d-flex justify-content-left align-items-left wow fadeInUp" data-wow-delay="0.1s">
        <h4 class="mb-0 wow fadeInUp">Selamat Datang <span class="fw-semibold nama-pengguna" style="color: #df3131;"></span>!<p class="pt-2">Segera Lengkapi Data Leads Anda</p>
        </h4>
    </div>
</section>
                ...
                <div class="col-6">
                    <div class="card-input wow fadeInUp">
                        ...
                        <div class="col-sm-1" style="width: 8%;padding-left:0px;padding-right: 0px">
                            ...
                            <!--</a>-->
                            <a href="#" type="button" class="form-select-custom col-1 d-flex width" style="width:40px;" data-bs-toggle="tooltip" data-bs-placement="top" title="Eksport Excel">
                                <img src="<?= base_url('assets\img\export.svg') ?>" width="40" style="padding:4px" alt="">
                            </a>
                        </div>
                    </div>
