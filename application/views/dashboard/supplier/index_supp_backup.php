        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-9" style="background-color: #B89494;">
                        <!-- Grafik Leads -->
                    </div>
                    <div class="col-md-3" style="background-color:#c50000;">
                        <!-- Tabel Tim Marketing -->
                    </div>
                </div>
            </div>
            <!-- Grafik Status CRM -->
            <div class="col-md-3 statusCRM" >
                <div class="row justify-content-center mx-1 px-1 ">
                    <h3 style="text-align: center;">Status CRM</h3>
                </div>
