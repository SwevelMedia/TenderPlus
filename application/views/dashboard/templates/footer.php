...
<footer class="sticky-footer bg-white">
    <div class="container my-auto d-flex justify-content-end">
        <div class="copyright text-center my-auto">
            <span>&copy;2022.Tender+ All Right Reserved</span>
        </div>
    </div>
    </div>
</footer>
...
<script src="<?= base_url("assets/js/profile/profile_nav.js") ?>"></script>
