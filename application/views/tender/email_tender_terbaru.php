...
<head>
    <title>Notifikasi Tender Terbaru</title>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
    					...
    					<?php if ($isUserTrial || $isUserPremium) : ?>
							<h4 style="margin: 5px 0 10px 0; font-weight: 400;">Halo <strong><?= $name ?></strong>,<br /> Terdapat <strong><?= $count_tender ?></strong> paket baru yang dapat Anda menangkan bersama TenderPlus. <?= ($count_tender > $limit_tender) ? 'Berikut ' . $limit_tender . ' diantaranya' : '' ?></h4>
							<a href="<?= $baseurl ?>/user-dashboard" class="btn">Lihat Semua Paket Baru<a>
    					<?php endif; ?>
    					<?php if($isUserFree) : ?>
							<h4 style="margin: 5px 0 10px 0; font-weight: 400;">Total paket baru: <span style="background: #FFF2F2;border: 1px solid #B02D19;padding: 5px;font-size: 16px;"><strong><?= $count_tender ?></strong></span> paket</h4>
    					<?php endif; ?>
                        </td>
                        <td width="200">
                    ...
                    <?php if ($isUserFree) : ?>
                        <tr>
                            <td colspan="2">
                                ...
                                Terdapat <strong><?= $count_tender ?> paket baru</strong> yang dapat Anda menangkan bersama TenderPlus. Silakan upgrade ke akun premium untuk dapat melihat daftar tender!
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><a href="<?= $baseurl ?>/pembayaran?role=2" class="btn">Upgrade Akun Sekarang<a></td>
                        </tr>
                    <?php endif; ?>
