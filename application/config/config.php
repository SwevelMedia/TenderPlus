...
|
*/
// $config['base_url'] = "http://localhost:8081/beecons/procurement-platform/";
if (!is_cli()) {
...
$config['sess_expiration'] = 5184000; // Durasi sesi dalam detik (2 bulan)
...
// 		$file = APPPATH . 'libraries/scrapping/' . $classname . '.php';
// 		if (file_exists($file)) {
// 			@include_once($file);
// 		}
// 	}
