...
$route['user-dashboard/data-by-status']['POST'] = 'DashboardUser/updateDataByStatus';
$route['suplier/crmReal'] = 'DashboardUserSupplier/crmReal';
...
$route['user-dashboard/market'] = 'Market2/indexMarket';
$route['user-dashboard/market2/dataForHpsLpse'] = 'Market2/dataForHpsLpse';
$route['user-dashboard/market2/proyekLpse'] = 'Market2/proyekLpse';
$route['user-dashboard/market2/getTabelDataPeserta'] = 'Market2/getTabelDataPeserta';
$route['user-dashboard/market2/dataTabelPesertaTender'] = 'Market2/dataTabelPesertaTender';
$route['user-dashboard/market2/getDataTablePeserta'] = 'Market2/getDataTablePeserta';
$route['user-dashboard/market2/jumTenderPeserta'] = 'Market2/jumTenderPeserta';
$route['user-dashboard/market2/getPesertaMenawar'] = 'Market2/getPesertaMenawar';
$route['user-dashboard/market2/getPesertaMenang'] = 'Market2/getPesertaMenang';
$route['user-dashboard/market-lama'] = 'Market2';
...
$route['api/supplier/updateDataLeadCRM/(:num)'] = 'api/ApiSupplier/editDataLeadCRM/$1';
