                ...
                if (!isset($token["error"])) {
                    ...
                    try {
                        ...
                        if ($result['status'] == 200) {
                            ...
                            set_cookie('id_pengguna', $userId, time()+86400*7);
        ...
        if ($this->form_validation->run() == false) {
            ...
            try {
                ...
                if ($user->is_active == 0) {
                    ...
                    set_cookie('id_pengguna', $userId, time()+86400*7);
                    set_cookie('kategori', $userCat, time() + 86400*7);
                    set_cookie('jenis_perusahaan', $companyType, time() + 86400*7);

                    set_cookie('status', $userStatus, time() + 86400*7);
